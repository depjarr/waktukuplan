...
/** Ikon garis sederhana (warnanya ikut teks). Pengganti emoji di tombol-tombol. */
const PATHS = {
  ...
  sparkle: <><path d="M12 3v3M12 18v3M3 12h3M18 12h3" /><path d="m6 6 2 2M16 16l2 2M18 6l-2 2M8 16l-2 2" /><path d="M12 8a4 4 0 0 0 4 4 4 4 0 0 0-4 4 4 4 0 0 0-4-4 4 4 0 0 0 4-4Z" /></>,
...
export function Icon({ n, size = 16 }: { n: IconName; size?: number }) {
  return (
    <svg className="ico-svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor"
